...
const styles = StyleSheet.create({
  ...
  rail: { borderRadius: 21, elevation: 8, overflow: 'hidden', position: 'absolute', right: 16, shadowColor: '#131A22', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.18, shadowRadius: 10, zIndex: 25 },
  railSurface: { borderColor: 'rgba(255,255,255,0.7)', borderRadius: 21, borderWidth: 1, overflow: 'hidden' },
});
