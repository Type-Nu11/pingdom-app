...
export const PRODUCTION_ROUTE_PARITY: readonly RouteParityEntry[] = [
  ...
  { activeImplementation: 'src/v2/features/map/screens/MapScreen.tsx + src/v2/modules/booking/reservations', removalIssues: [], route: 'ReservationList', status: 'V2_READY' },
