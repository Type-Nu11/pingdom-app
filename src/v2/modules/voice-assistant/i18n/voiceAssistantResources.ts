export const voiceAssistantResources = {
  en: {
    ...
    input: 'Your request', placeholder: 'Ask me anything!', submit: 'Confirm input', settings: 'Open microphone settings',
  ...
  ko: {
    ...
    input: '요청 내용', placeholder: '무엇이든 물어보세요!', submit: '입력 확인', settings: '마이크 설정 열기',
