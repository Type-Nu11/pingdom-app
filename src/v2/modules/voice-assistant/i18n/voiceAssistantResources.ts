export const voiceAssistantResources = {
  en: {
    ...
    open: 'Open AI assistant', shortLabel: 'AI', brand: 'Pingdy', title: 'AI assistant', close: 'Close assistant', microphone: 'Start microphone', stop: 'Stop and review', cancel: 'Cancel input',
    input: 'Your request', placeholder: 'Ask me anything!', submit: 'Confirm input', settings: 'Open microphone and speech recognition settings',
    speechProcessing: 'Voice recognition uses your device’s speech service. Audio may be processed off device. Pingdom does not store the source audio. The service’s retention policy may vary.',
  ...
  ko: {
    ...
    open: 'AI 어시스턴트 열기', shortLabel: 'AI', brand: 'Pingdy', title: 'AI 어시스턴트', close: '어시스턴트 닫기', microphone: '마이크 시작', stop: '중지하고 확인', cancel: '입력 취소',
    input: '요청 내용', placeholder: '무엇이든 물어보세요!', submit: '입력 확인', settings: '마이크·음성 인식 설정 열기',
    speechProcessing: '기기의 음성 인식 서비스를 사용합니다. 음성이 기기 밖에서 처리될 수 있습니다. 핑덤은 원본 음성을 저장하지 않으며, 인식 서비스의 보관 정책은 서비스에 따라 다를 수 있습니다.',
