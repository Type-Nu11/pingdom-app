...
import type { MapPlaceCardViewModel, MapPlaceSupportTag } from '../../selection/model/mapDiscovery';
...
const Name = styled(AppText)`max-width: 75%; color: ${({ theme }) => theme.colors.textStrong}; font-size: ${({ theme }) => theme.typography.title.fontSize}px; font-weight: ${({ theme }) => theme.typography.title.fontWeight};`;
const Category = styled(AppText)`flex: 1; color: ${({ theme }) => theme.colors.textMuted}; font-size: ${({ theme }) => theme.typography.body.fontSize}px;`;
const Meta = styled(AppText)`margin-top: 2px; color: ${({ theme }) => theme.colors.textMuted}; font-size: ${({ theme }) => theme.typography.caption.fontSize}px;`;
const Operating = styled(AppText)<{ $open: boolean }>`margin-top: 2px; color: ${({ $open, theme }) => $open ? theme.colors.success : theme.colors.textMuted}; font-size: ${({ theme }) => theme.typography.caption.fontSize}px; font-weight: ${({ theme }) => theme.typography.label.fontWeight};`;
...
const CircleLabel = styled(AppText)`color: ${({ theme }) => theme.colors.textMuted}; font-size: 28px; line-height: 30px;`;
const Favorite = styled(AppText)<{ $selected: boolean }>`color: ${({ $selected, theme }) => $selected ? theme.colors.primary : theme.colors.textDisabled}; font-size: 20px;`;
...
const SupportIcon = styled(AppText)`color: ${({ theme }) => theme.colors.primary}; font-size: ${({ theme }) => theme.typography.body.fontSize}px;`;
const SupportLabel = styled(AppText)`color: ${({ theme }) => theme.colors.textMuted}; font-size: ${({ theme }) => theme.typography.label.fontSize}px;`;
...
const ActionText = styled(AppText)`color: ${({ theme }) => theme.colors.textMuted}; font-size: ${({ theme }) => theme.typography.label.fontSize}px;`;
const PrimaryActionText = styled(ActionText)`color: ${({ theme }) => theme.colors.primary};`;
const Summary = styled(AppText)`margin: ${({ theme }) => theme.spacing.md}px ${({ theme }) => theme.spacing.md}px 0; color: ${({ theme }) => theme.colors.text}; font-size: ${({ theme }) => theme.typography.caption.fontSize}px;`;
const Notice = styled(AppText)`margin: ${({ theme }) => theme.spacing.sm}px ${({ theme }) => theme.spacing.md}px 0; color: ${({ theme }) => theme.colors.warning}; font-size: ${({ theme }) => theme.typography.caption.fontSize}px;`;
...
const ImageFallbackText = styled(AppText)`color: ${({ theme }) => theme.colors.textMuted}; font-size: ${({ theme }) => theme.typography.caption.fontSize}px;`;
const BodyText = styled(AppText)`color: ${({ theme }) => theme.colors.textMuted}; font-size: ${({ theme }) => theme.typography.caption.fontSize}px;`;
...
const RetryLabel = styled(AppText)`color: ${({ theme }) => theme.colors.primary}; font-size: ${({ theme }) => theme.typography.caption.fontSize}px; font-weight: ${({ theme }) => theme.typography.label.fontWeight};`;
