      ...
      myPage: {
        ...
        couponBox: {
          ...
          emptyByStatus: {
            ...
            ISSUED: 'No coupons available to use',
            REDEEMED: 'No used coupons',
          },
          ...
          redeemedAt: 'Used {{date}}',
          redeemedUnknown: 'Used',
          status: {
            EXPIRED: 'Expired',
            ISSUED: 'Available',
            REDEEMED: 'Used',
          ...
          title: 'Coupon box',
          unusable: 'This coupon can no longer be used',
          use: 'Use coupon',
        },
        couponDetail: {
          ...
          defaults: {
            condition: 'One-time use at checkout',
            exclusion: 'Alcohol and takeout items are excluded from the discount',
            stores: 'Participating stores',
            usage: 'In-store · Pingdom reservations only (no delivery)',
          },
    ...
    translation: {
      ...
      myPage: {
        ...
        couponBox: {
          ...
          emptyByStatus: {
            EXPIRED: '만료된 쿠폰이 없어요',
            ISSUED: '사용 가능한 쿠폰이 없어요',
            REDEEMED: '사용 완료한 쿠폰이 없어요',
          },
          error: '쿠폰을 불러오지 못했어요.',
          expired: '기간 만료',
          expiresAt: '{{date}}까지',
        ...
        couponDetail: {
          ...
          defaults: {
            condition: '결제 시 1회 사용 가능',
            exclusion: '주류 · 포장 메뉴는 할인에서 제외돼요',
            stores: '가맹 매장',
            usage: '매장 방문 · 핑덤 예약 전용 (배달 주문 불가)',
          },
