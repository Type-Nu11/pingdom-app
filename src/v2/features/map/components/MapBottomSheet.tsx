    ...
    >
      ...
      >
        ...
        {shouldRenderExpandedContent && !restingScrollEnabled ? (
          ...
          >
            <AppText style={styles.expandedTitle}>{t('map.sheet.categoryPopular', { userName })}</AppText>
...
const EmptyCard = ({
  ...
  return (
    <View style={[variant === 'row' ? styles.emptyCardRow : styles.placeCard, styles.emptyCard]}>
      ...
      <AppText style={styles.emptyCardTitle}>{t(`map.sheet.state.${copyState}Title`)}</AppText>
      <AppText style={styles.emptyCardBody}>{t(`map.sheet.state.${copyState}Body`)}</AppText>
    </View>
  );
};
