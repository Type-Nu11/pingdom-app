...
export const placeReportResources = {
  en: {
    placeReport: {
      ...
      card: {
        ...
        description: 'Your record is the first note in this place’s story.',
      },
      category: {
        beauty: 'Beauty',
        cafe: 'Cafe',
      ...
      field: {
        ...
        detailAddress: 'Detailed address (required)',
        detailAddressPlaceholder: 'Enter a detailed address',
        features: 'Features (optional)',
        operationHours: 'Operating hours (required)',
        operationHoursPlaceholder: '09:00 ~ 20:00',
        photo: 'Add 1 photo (optional)',
  ...
  ko: {
    placeReport: {
      ...
      card: {
        badge: 'First Recorder',
        description: '이 장소가 알려지고 변해가는 과정에 첫 기록이 남았어요.',
      },
      category: {
        beauty: '뷰티',
        cafe: '카페',
