...
describe('getOfferCouponErrorUx', () => {
  ...
  const cases: Array<{
    ...
    {
      title: 'redeem 409 without a server code → used-or-expired umbrella',
      surface: 'redeem',
      error: { status: 409 },
      reason: 'redeemUsedOrExpired',
      cta: 'back',
      retryable: false,
    },
    {
      title: 'redeem 400 VALIDATION_FAILED → invalid redeem input',
      surface: 'redeem',
      error: { status: 400, code: 'VALIDATION_FAILED' },
      reason: 'redeemInvalidInput',
      cta: 'back',
      retryable: false,
    },
    {
    ...
    {
      title: 'redeem 409 COUPON_ALREADY_REDEEMED → no rollback, back to the scanner',
      surface: 'redeem',
