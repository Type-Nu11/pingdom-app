    ...
    translation: {
      ...
      auth: {
        ...
        passwordReset: {
          ...
          invalidToken: 'That reset code is not valid. Check the code or request a new one.',
          ...
          sendToken: 'Send reset code',
          submit: 'Reset password',
          token: 'Reset code',
          tokenPlaceholder: 'Enter the code from your email',
          tokenRequired: 'Please enter the reset code',
          unknownError: 'An unknown error occurred while resetting your password.',
        },
        signup: {
          title: 'Start Pingdom',
  ...
  ko: {
    translation: {
      ...
      auth: {
        ...
        passwordReset: {
          confirmDescription: '{{email}}로 보낸 재설정 코드를 입력하고 새 비밀번호를 설정해주세요.',
          confirmTitle: '새 비밀번호 설정',
          invalidToken: '재설정 코드가 올바르지 않습니다. 코드를 확인하거나 다시 요청해주세요.',
          newPassword: '새 비밀번호',
          newPasswordPlaceholder: '8자 이상 입력하세요',
          passwordTooShort: '비밀번호는 8자 이상이어야 합니다',
          processing: '처리 중...',
          requestDescription: '가입한 이메일을 입력하시면 재설정 코드를 보내드려요.',
          requestTitle: '비밀번호 재설정',
          resend: '코드 다시 보내기',
          sendToken: '재설정 코드 받기',
          submit: '비밀번호 재설정하기',
          token: '재설정 코드',
          tokenPlaceholder: '메일로 받은 코드를 입력하세요',
          tokenRequired: '재설정 코드를 입력해주세요',
          unknownError: '비밀번호 재설정 중 알 수 없는 오류가 발생했습니다.',
        },
        signup: {
          title: '핑덤 시작하기',
      ...
      myPage: {
        ...
        settings: '설정',
        title: '마이페이지',
        profileUnavailable: '프로필 정보를 불러올 수 없습니다',
